            ...
            >
              <div className="flex items-center gap-2">
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-green-100 text-sm font-bold uppercase text-green-700">
                  {logedInData?.profile?.first_name?.[0]}
                  {logedInData?.profile?.last_name?.[0]}
                </div>
                <div className="px-[5px] text-center">
                  <div className="font-semibold">
                    {logedInData?.profile?.first_name} {logedInData?.profile?.last_name}
                  </div>
                  <div className="text-sm text-green-500">{logedInData?.profile?.role}</div>
                </div>
              </div>
