...
import type { StudentListWithGroupsProps } from "../../../../../Interfaces/Student.interface";
...
</div>:<p className="text-center text-lg font-bold text-gray-500 shadow-xl"> No Students Available Now</p>}
